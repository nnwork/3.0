...
public class AdminComplainStatusAdapter extends BaseAdapter {

    Activity activity;
    List<ComplainClassFile> complainClassFileList;

    public AdminComplainStatusAdapter(Activity activity, List<ComplainClassFile> complainClassFileList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView admin_complain_id=(TextView)view.findViewById(R.id.admin_complain_id);
...
//        TextView admin_complain_date_time=(TextView)view.findViewById(R.id.admin_complain_date_time);
        ...
        admin_complain_id.setText(item.getComplain_id());
