...
import com.customerservice.login.Admin.HelperViewActivity;
...
public class AdminHomeActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(AdminHomeActivity.this, HelperViewActivity.class);
            startActivity(intent);
        }
        else if(id==R.id.nav_suggestion)
        {
        ...
        {
            Intent intent = new Intent(AdminHomeActivity.this, VisitorActivity.class);
            startActivity(intent);
        }
        else if(id==R.id.nav_watchman)
        {
            Intent intent = new Intent(AdminHomeActivity.this, WatchmanActivity.class);
            startActivity(intent);
        }
